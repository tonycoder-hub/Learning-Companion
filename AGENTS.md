...
│   │   ├── index.html
│   │   ├── styles.css
│   │   ├── service-worker.js   # Cache: learning-companion-static-v11
...
- Schema versions: `WORKSPACE_SCHEMA_VERSION = 2`, `UI_PREFS_SCHEMA_VERSION = 7` (in app.js).
...
UI prefs stored separately: key `learning-companion.ui.v1`, version 7.
