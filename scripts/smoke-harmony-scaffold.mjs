...
export function buildHarmonyScaffoldReport(options = {}) {
  ...
  const checks = [
    ...
    check("entry_string_bilingual_desc", /HarmonyOS 脚手架/.test(files.get("entry/src/main/resources/base/element/string.json")) && /只读学习镜像与补丁交接/.test(files.get("entry/src/main/resources/base/element/string.json"))),
    ...
    check("unsupported_receipt", /UNSUPPORTED_PORTABLE_DATA/.test(files.get("entry/src/main/ets/services/importPortableData.ets")) && /PATCH_IMPORT_NOT_SUPPORTED_ON_READER/.test(files.get("entry/src/main/ets/services/importPortableData.ets")) && /phone reader does not import them/.test(files.get("entry/src/main/ets/services/importPortableData.ets"))),
    ...
    check("import_picker_contract_bilingual", /使用前台文档选择器/.test(files.get("entry/src/main/ets/services/importPortableData.ets")) && /请选择 \.json 工作区或镜像包文件/.test(files.get("entry/src/main/ets/services/importPortableData.ets")) && /reader 只能打开工作区或镜像包 JSON/.test(files.get("entry/src/main/ets/services/importPortableData.ets"))),
    ...
    check("visible_page_bilingual_shell", [
      "entry/src/main/ets/pages/Index.ets",
      "entry/src/main/ets/pages/TopicDetail.ets",
      "entry/src/main/ets/pages/ReviewQueue.ets",
      "entry/src/main/ets/pages/ImportReceipt.ets"
    ].every((path) => /harmonyScaffold(Label|Text)/.test(files.get(path))) && /手机下一步/.test(files.get("entry/src/main/ets/pages/Index.ets")) && /主题详情/.test(files.get("entry/src/main/ets/pages/TopicDetail.ets")) && /复习队列/.test(files.get("entry/src/main/ets/pages/ReviewQueue.ets")) && /导入回执/.test(files.get("entry/src/main/ets/pages/ImportReceipt.ets"))),
    ...
    check("return_to_mac_contract_bilingual", /手机侧工作会导出/.test(files.get("entry/src/main/ets/services/exportPatch.ets")) && /手动飞书云文档/.test(files.get("entry/src/main/ets/services/exportPatch.ets")) && /在 Mac 的 Today > Return Files 导入/.test(files.get("entry/src/main/ets/services/exportPatch.ets"))),
    check("return_to_mac_pages", /describeReturnToMacContract/.test(files.get("entry/src/main/ets/pages/Index.ets")) && /Import reader \/ Return to Mac/.test(files.get("entry/src/main/ets/pages/Index.ets")) && /Return patches are Mac-bound only/.test(files.get("entry/src/main/ets/pages/Index.ets")) && ["entry/src/main/ets/pages/TopicDetail.ets", "entry/src/main/ets/pages/ReviewQueue.ets"].every((path) => /describeReturnToMacContract/.test(files.get(path)) && /Manual Return/.test(files.get(path))) && /describeReturnToMacContract/.test(files.get("entry/src/main/ets/pages/ImportReceipt.ets")) && /Next Phone Pass/.test(files.get("entry/src/main/ets/pages/ImportReceipt.ets"))),
