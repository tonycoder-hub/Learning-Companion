...
assert.match(reviewHtml, /Save picker unavailable here\. Return file selected; copy it manually\./);
...
assert.match(inboxHtml, /Save picker unavailable here\. Return file selected; copy it manually\./);
