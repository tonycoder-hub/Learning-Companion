...
assert.match(koNextActionSummaryJs, /validatePublicDryRunReceiptBasis/);
assert.match(koNextActionSummaryJs, /validateApprovedCandidateCommand/);
assert.match(koNextActionSummaryJs, /buildApprovedCandidateCommand/);
assert.match(koNextActionSummaryJs, /does not match receipt-validated sources/);
assert.match(koNextActionSummaryJs, /Prior public dry-run receipt path is missing/);
assert.match(koNextActionSummaryJs, /external-source-validation-browser\.v1/);
assert.match(koNextActionSummaryJs, /profileRetained is false/);
assert.match(koNextActionSummaryJs, /CURRENT_CLEAN_PUBLIC_DRY_RUN/);
assert.match(koNextActionSummaryJs, /STALE_OR_DIRTY_PUBLIC_DRY_RUN/);
assert.match(koNextActionSummaryJs, /has no public dry-run receipt basis/);
...
assert.match(nextMajorOperatorPacketJs, /validatePublicDryRunReceiptBasis/);
assert.match(nextMajorOperatorPacketJs, /validateApprovedCandidateCommand/);
assert.match(nextMajorOperatorPacketJs, /buildApprovedCandidateCommand/);
assert.match(nextMajorOperatorPacketJs, /does not match receipt-validated sources/);
assert.match(nextMajorOperatorPacketJs, /Prior public dry-run receipt path is missing/);
assert.match(nextMajorOperatorPacketJs, /external-source-validation-browser\.v1/);
assert.match(nextMajorOperatorPacketJs, /profileRetained is false/);
