...
assert.match(appJs, /Thought captured · card only if recall matters/);
...
assert.match(reviewHtml, /On a phone: use Copy or Manual Copy/);
assert.match(reviewHtml, /paste the return JSON into a note, email, or message/);
assert.match(reviewHtml, /AirDrop, USB, file share, or manual Feishu Drive upload also work after the JSON file is saved/);
...
assert.match(inboxHtml, /On a phone: use Copy or Manual Copy/);
assert.match(inboxHtml, /paste the return JSON into a note, email, or message/);
assert.match(inboxHtml, /AirDrop, USB, file share, or manual Feishu Drive upload also work after the JSON file is saved/);
