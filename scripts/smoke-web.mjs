...
assert.match(reviewHtml, /Save Return JSON/);
assert.match(reviewHtml, /copyProgressBtn" type="button">Copy Return JSON/);
...
assert.match(inboxHtml, /copyPatchBtn" type="button">Copy Return JSON/);
...
assert.match(mirrorIndexHtml, /Return JSON back to Mac/);
