...
assert.match(koEvidenceReviewJs, /Windows platform PASS rows with placeholder evidence notes rejected/);
assert.match(koEvidenceReviewJs, /Harmony platform PASS rows with decorated placeholder evidence notes rejected/);
