...
assert.match(appJs, /renderStartHereCard/);
...
assert.match(appCss, /\.start-here-card/);
...
assert.match(reviewHtml, /copyProgressBtn" class="secondary"/);
...
assert.match(inboxHtml, /copyPatchBtn" class="secondary"/);
...
assert.match(mirrorIndexHtml, /static mirror, not live sync/);
