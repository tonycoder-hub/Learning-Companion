...
- Privacy-review templates/claims and top-level KO status/final JSON are written as `0600` files under `0700` parent directories; path-valued CLI flags reject bare boolean use so missing paths do not turn into accidental output locations.
