...
| Question close loop | In Today, use the open question's Make card, then Resolve and Reopen on a question capture. | Make card creates a review card in the source topic; Resolve removes it from Open Questions; Reopen restores it. | NT |  |
