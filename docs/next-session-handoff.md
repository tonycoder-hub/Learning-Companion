...
- Evidence boundary: the Review storage-failure browser fixture currently proves one graded card. Add a dedicated multi-due-card static Review fixture before claiming multiple in-memory review events are covered under the same blocked-storage path.
