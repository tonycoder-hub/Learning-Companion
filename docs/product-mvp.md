...
- Local storage backup notice appears after committed learning data changes, and export asks the user to confirm the requested JSON download was actually saved.
