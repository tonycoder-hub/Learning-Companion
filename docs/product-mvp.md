...
- Generated `TODAY.md` and the Morning Review Pack now carry English source-of-truth labels plus adjacent Chinese aliases/notes for the pack shell, so Feishu/Windows/mobile handoff documents are not English-only. Per-session Markdown, mirror `README.md`, synthesis drafts, QA receipts, and platform-specific manual QA templates remain separate bilingual surfaces.
