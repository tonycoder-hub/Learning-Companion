...
- That answer-return loop is local static HTML plus Mac import evidence only; real `file://`, HarmonyOS/Windows storage and save behavior, Feishu Drive transfer, and multi-answer batch return files remain separate QA gaps.
